SELECT
              ...
              CASE
                ...
                WHEN BettingOffers.bettingTypeId =  45 THEN
                  CASE
                    ...
                    WHEN CONCAT(Outcomes.paramFloat1, '', Outcomes.paramFloat2) IN ('21', '03', '22') THEN 2
                    WHEN CONCAT(Outcomes.paramFloat1, '', Outcomes.paramFloat2) IN ('30', '04', '33') THEN 3
                    WHEN CONCAT(Outcomes.paramFloat1, '', Outcomes.paramFloat2) IN ('31', '12', '44') THEN 4
                    WHEN CONCAT(Outcomes.paramFloat1, '', Outcomes.paramFloat2) IN ('32', '13') THEN 5
                    WHEN CONCAT(Outcomes.paramFloat1, '', Outcomes.paramFloat2) IN ('40', '14') THEN 6
                    WHEN CONCAT(Outcomes.paramFloat1, '', Outcomes.paramFloat2) IN ('41', '23') THEN 7
              ...
              CASE
                WHEN (BettingOfferStatuses.isAvailable = 1 AND Events.statusId = 1) THEN 2
                WHEN (BettingOfferStatuses.isAvailable = 0 AND Events.statusId = 2) THEN 5
                WHEN (BettingOfferStatuses.isAvailable = 0 AND Events.statusId = 3) THEN 6
                ELSE 8
              END AS bg_status,
